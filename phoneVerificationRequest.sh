...
echo
echo Response:
curl -s -X POST "https://api.authy.com/protected/$AUTHY_API_FORMAT/phones/verification/start?api_key=$AUTHY_API_KEY&via=sms&country_code=$USER_COUNTRY&phone_number=$USER_PHONE" | underscore print --outfmt pretty
echo
