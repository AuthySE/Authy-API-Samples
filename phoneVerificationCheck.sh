...
echo
echo Response:
curl -s "https://api.authy.com/protected/$AUTHY_API_FORMAT/phones/verification/check?api_key=$AUTHY_API_KEY&phone_number=$USER_PHONE&country_code=$USER_COUNTRY&verification_code=$1" | underscore print --outfmt pretty
echo
